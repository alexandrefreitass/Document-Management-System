...
?>  > 
          <td height="13"> <div align="left"><a href="geralconsadm.php?cod_org=<?php echo $row_listadoc['Cod_Org']; ?>&Tipo_Doc=<?php echo $row_listadoc['Tipo_Doc']; ?>&ano=<?php echo date("y");  ?>&re=<?php echo $_GET['re']; ?>&num_doc=%&ass=%&des=%" target="congeral"><?php echo $row_listadoc['DescTipo_Doc']; ?></a></div></td>
        </tr>
        <?php 
